  ...
  return (
    <div className="flex flex-col min-h-screen ">
      <main className="flex-1">
          ...
          <div className="container px-4 md:px-6">
            <div className="flex flex-col items-center space-y-4 text-center">
              ...
              <div className="space-x-4">
                <Button size="lg" className="bg-[#fe6b01]  hover:text-[#fe6b01] hover:bg-white hover:border border-[#fe6b01]">Get Started</Button>
                <Button variant="outline" size="lg" className=" border-[#0991f8] text-[#0991f8] hover:bg-[#0991f8] hover:text-white">
                  Learn More
                </Button>
              </div>
            </div>
        ...
        <section className="w-full bg-[#f5d5bf] py-12 md:py-24 lg:py-32  dark:bg-gray-800">
          <div className="container px-4 md:px-6 max-w-screen-2xl mx-auto">
            ...
            <div className="grid gap-6 lg:grid-cols-3">
              <Card className="flex flex-col items-center text-center p-6">
                <Globe className="h-12 w-12 mb-4 text-[#fe6b01]" />
              ...
              <Card className="flex flex-col items-center text-center p-6">
                <Target className="h-12 w-12 mb-4 text-[#fe6b01]" />
              ...
              <Card className="flex flex-col items-center text-center p-6">
                <TrendingUp className="h-12 w-12 mb-4 text-[#fe6b01]" />
        ...
        <section className="w-full py-20">
          <div className="container px-4 md:px-6 flex flex-col w-full items-center gap-8 max-w-screen-2xl mx-auto">
        ...
        <section className="w-full py-12 md:py-24 lg:py-32 bg-[#f5d5bf] dark:bg-gray-800">
          <div className="container px-4 md:px-6 max-w-screen-2xl mx-auto">
            ...
            <div className="grid gap-6 lg:grid-cols-2">
              <Card className="p-6">
                ...
                <cite className="flex items-center">
                  <Image src="/team-1.jpg" alt="Jane Doe" width={40} height={40} className="rounded-full mr-4" />
                  <div>
              ...
              <Card className="p-6">
                ...
                <cite className="flex items-center">
                  <Image src="/team-2.jpg" alt="John Smith" width={40} height={40} className="rounded-full mr-4" />
                  <div>
            ...
            <div className="flex flex-col items-center space-y-4 text-center">
              ...
              <div className="w-full max-w-sm space-y-2">
                <form className="flex space-x-2">
                  ...
                  <Button type="submit" className="bg-[#fe6b01] hover:text-[#fe6b01] hover:bg-white hover:border border-[#fe6b01]">
                    Contact Us
